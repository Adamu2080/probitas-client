...
- **README.md**: Project overview, package list, and quick start guide
- **Package JSDoc**: Comprehensive API documentation in each package's `mod.ts`
  (published to JSR)
- **Releases.md**: Auto-generated by Bump CI - **DO NOT edit manually**
